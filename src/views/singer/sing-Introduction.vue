<template>
    <div>
        ...
        <scroll class="content" ref="scroll" :probe-type="3" :pull-up-load="true">
            <div>
                <div
                        style="background:red;width: 4px;height: 16px;float:left;margin-left: 10px;margin-top: 2px;border-radius: 2px"
                ></div>
                <div style="margin: 10px  0 0 20px">{{ this.xiangqing.name }}简介</div>
                <div class="textstyle">{{ this.SingerDescribe.briefDesc }}</div>
                <div v-for="(item,index) in this.SingerDescribe.introduction" :key="index">
