        ...
        <scroll class="content" ref="scroll"
            ...
            <div>
                <div style="width: 100%;height: 280px;position: relative">
                    <img :src="xiangqing.picUrl" style="width: 100%;height: 100%" alt="">
                    ...
                    <div style="position: absolute;top: 200px;font-size: 20px;font-weight: bold;color: white;margin-left: 16px">
                        {{xiangqing.name}}
                    </div>
                </div>
