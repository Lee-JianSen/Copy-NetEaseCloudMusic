  ...
  methods: {
    ...
    activeChange (name, title) {
      switch (name) {
        case 'tj':
          this.limit = 51
          if (this.allType[0].data.length === 0) {
            this.getAllPlayListData({
              limit: 51,
              cat: '全部',
              dataType: this.allType[0].data
        ...
        case 'hy':
          this.limit = 51
          if (this.allType[2].data.length === 0) {
            this.getAllPlayListData({
              limit: 51,
              cat: '华语',
        ...
        case 'lx':
          this.limit = 51
          if (this.allType[3].data.length === 0) {
            this.getAllPlayListData({
              limit: 51,
              cat: '流行',
        ...
        case 'yg':
          this.limit = 51
          if (this.allType[4].data.length === 0) {
            this.getAllPlayListData({
              limit: 51,
              cat: '摇滚',
        ...
        case 'my':
          this.limit = 51
          if (this.allType[5].data.length === 0) {
            this.getAllPlayListData({
              limit: 51,
              cat: '民谣',
