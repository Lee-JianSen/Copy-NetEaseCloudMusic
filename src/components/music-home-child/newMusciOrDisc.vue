<template>
    <div class="newMusicOrDisc">
        <div class="topTitle">
            <h4>
                <span @click="showNewMusic" :class="{'notSelectColor':!isShowMusic}">新歌</span>
                |&nbsp<span @click="showNewMusic" :class="{'notSelectColor':isShowMusic}">新碟</span>
            </h4>
            <btn-more title="更多"/>
        </div>
        <horizontal-scroll ref="hScroll">
            <div ref="list" class="list">
                <recommend-music-com v-show="isShowMusic" :recommend-music="newMusic" @playMusicClick="getMusicId"/>
